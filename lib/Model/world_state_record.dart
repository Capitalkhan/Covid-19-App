/// updated : 1700586225531
/// cases : 698005437
/// todayCases : 67029
/// deaths : 6940593
/// todayDeaths : 103
/// recovered : 669544962
/// todayRecovered : 44397
/// active : 21519882
/// critical : 35278
/// casesPerOneMillion : 89548
/// deathsPerOneMillion : 890.4
/// tests : 7009045731
/// testsPerOneMillion : 882203.02
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2708.63
/// recoveredPerOneMillion : 84273.18
...
class WorldStateRecord {
  ...
  WorldStateRecord.fromJson(dynamic json) {
...
WorldStateRecord copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStateRecord(  updated: updated ?? _updated,
  cases: cases ?? _cases,
